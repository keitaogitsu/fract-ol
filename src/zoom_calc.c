...
/*   Updated: 2023/08/06 19:30:37 by kogitsu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	printf("scr_co(x0):%lf| scr_co(x1):%lf\n", vars->scr_co->x0, vars->scr_co->x1);
	printf("scr_co(y0):%lf| scr_co(y1):%lf\n", vars->scr_co->y0, vars->scr_co->y1);
